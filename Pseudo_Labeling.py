...
history1 = model.fit(Xtrain1, Ytrain1, batch_size=batch_size, epochs=8, verbose=1, callbacks=[earlyStopping, mcp_save, reduce_lr_loss], validation_split=0.25)
...
history2 = model.fit(Xtrain2, Ytrain2, batch_size=batch_size, epochs=8, verbose=1, callbacks=[earlyStopping, mcp_save, reduce_lr_loss], validation_split=0.25)
...
fig.savefig('performance_compared_no_round_test.png')
